...
local tscope_display_fns = {}

function tscope_display_fns.format_picker_result(opts)
  opts = opts or {}
  local file_icons, _ = devicons.get_icon("file", "", { default = true })
  ...
  local displayer = entry_display.create {
    ...
    items = {
     { width = bufnr_width },
     { width = 4 },
     { width = vim.fn.strwidth(file_icons) },
     { remaining = true },
   },
  }
